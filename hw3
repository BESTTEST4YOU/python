...
while True:
    def myfunc(arg1, arg2):
        try:
            ...
            return print('Division on 0')
    print(myfunc((int(input('Enter first number: '))), (int(input('Enter second number: ')))))
...
# Robert Paulson 1980 NewYork rb@yahoo.com 989898

print('Who are You?')
def myfunc(**kwargs):
    return list(kwargs.values())
print(', '.join(myfunc(name=input('Name: '),
                name2=input('Surname: '),
